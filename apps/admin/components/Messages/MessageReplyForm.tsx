...
import { Send, Paperclip, Image, FileText, Mic, X } from "lucide-react";
...
export const MessageReplyForm: React.FC<MessageReplyFormProps> = ({
  ...
  const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>, type: "image" | "audio" | "document") => {
    ...
    <div className="flex flex-col gap-2">
      ...
      <form onSubmit={handleSubmit} className="space-y-2">
        ...
        <p className="text-xs text-gray-600 dark:text-gray-400">
          💡 Use / para ver os seus templates salvos | 📎 Clique nos ícones para anexar imagens, áudios ou PDFs
        </p>
      </form>
    </div>
  );
